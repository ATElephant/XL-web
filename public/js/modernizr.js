...
window.Modernizr = function(a, b, c) {
		...
		!A(w, "undefined") && !A(w.call, "undefined") ? x = function(a, b) {
			...
			var c;
			return "ontouchstart" in a || a.DocumentTouch && b instanceof DocumentTouch ? c = !0 : u(["@media (", m.join(
		...
		return e.addTest = function(a, b) {
			...
			function(a, b) {
				...
				a.html5 = r, q(b)
			}(this, b), e._version = d, e._prefixes = m, e.mq = v, e.testStyles = u, g.className = g.className.replace(
				/(^|\s)no-js(\s|$)/, "$1$2") + (f ? " js " + r.join(" ") : ""), e
	}(this, this.document),
	function(a, b, c) {
		function d(a) {
